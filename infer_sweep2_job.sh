#!/bin/bash
#SBATCH --job-name=ksl-gpt-sweep2
...
#SBATCH --mem=48G
#SBATCH --time=1:00:00
#SBATCH --output=/scratch/katoch.aa/text-to-motion/logs/sweep2_gpt_%j.out
#SBATCH --error=/scratch/katoch.aa/text-to-motion/logs/sweep2_gpt_%j.err
...
ls -lh "$WORKDIR"/submission_gpt_t0.5*.csv "$WORKDIR"/submission_gpt_t0.6*.csv
