...
#SBATCH --mem=48G
#SBATCH --time=1:00:00
#SBATCH --output=/scratch/katoch.aa/text-to-motion/logs/train_gpt_%j.out
#SBATCH --error=/scratch/katoch.aa/text-to-motion/logs/train_gpt_%j.err
...
NEXT_JOB=$(sbatch --dependency=afterany:$SLURM_JOB_ID "$WORKDIR/train_gpt_job.sh" | awk '{print $4}')
